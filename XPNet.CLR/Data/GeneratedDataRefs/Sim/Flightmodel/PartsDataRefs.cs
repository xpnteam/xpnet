...
namespace XPNet.Data
{
    public class sim_flightmodel_partsDatarefs
    {
        ...
        /// <summary>
        ///  [GEAR] This is amount the Nth gear is deflected upwards due to vehicle weight on struts.
        /// </summary>
        ...
        /// <summary>
        ///  73 [WING] with flap setting, and then variation with pitch and roll input, on a 4 wing plane, with flaps on every wing, some going up and down with pitch input, we better find the flap def on each surface!
        /// </summary>
        public IXPDataRef<float[]> flap_def { get { return m_data.GetFloatArray("sim/flightmodel/parts/flap_def");} }

        /// <summary>
        ///  56 [WING] with flap setting, and then variation with pitch and roll input, on a 4 wing plane, with flaps on every wing, some going up and down with pitch input, we better find the flap def on each surface!
        /// </summary>
        public IXPDataRef<float[]> flap2_def { get { return m_data.GetFloatArray("sim/flightmodel/parts/flap2_def");} }

        /// <summary>
        ///  73 [WING] different for each part since def may be positive on a canard and negative on an aft wing... ON THE SAME PLANE AT THE SAME TIME!
        /// </summary>
