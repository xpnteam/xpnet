...
namespace XPNet.Data
{
    public class sim_flightmodel2_miscDataRefs
    {
        ...
        ///  Raw path: sim/flightmodel2/misc/canopy_open_ratio
        /// </summary>
        ...
        ///  Raw path: sim/flightmodel2/misc/door_open_ratio
        /// </summary>
        ...
        ///  Raw path: sim/flightmodel2/misc/tailhook_deploy_ratio
        /// </summary>
        ...
        ///  Raw path: sim/flightmodel2/misc/water_scoop_deploy_ratio
        /// </summary>
        ...
        ///  Raw path: sim/flightmodel2/misc/water_drop_deploy_ratio
        /// </summary>
        ...
        ///  Raw path: sim/flightmodel2/misc/wiper_angle_deg
        /// </summary>
        ...
        ///  Raw path: sim/flightmodel2/misc/custom_slider_ratio
        /// </summary>
        ...
        ///  Raw path: sim/flightmodel2/misc/pressure_outflow_ratio
        /// </summary>
        ...
        ///  Raw path: sim/flightmodel2/misc/bouncer_x
        /// </summary>
        ...
        ///  Raw path: sim/flightmodel2/misc/bouncer_y
        /// </summary>
        ...
        ///  Raw path: sim/flightmodel2/misc/bouncer_z
        /// </summary>
        public IXPDataRef<float[]> bouncer_z { get { return m_data.GetFloatArray("sim/flightmodel2/misc/bouncer_z");} }

        /// <summary>
        ///  lateral offset in meters from default for this bouncer. Units:meters
        ///  Raw path: sim/flightmodel2/misc/bouncer_vx
        /// </summary>
        public IXPDataRef<float[]> bouncer_vx { get { return m_data.GetFloatArray("sim/flightmodel2/misc/bouncer_vx");} }

        /// <summary>
        ///  vertical offset in meters from default for this bouncer. Units:meters
        ///  Raw path: sim/flightmodel2/misc/bouncer_vy
        /// </summary>
        public IXPDataRef<float[]> bouncer_vy { get { return m_data.GetFloatArray("sim/flightmodel2/misc/bouncer_vy");} }

        /// <summary>
        ///  longitudinal offset in meters from default for this bouncer. Units:meters
        ///  Raw path: sim/flightmodel2/misc/bouncer_vz
        /// </summary>
        public IXPDataRef<float[]> bouncer_vz { get { return m_data.GetFloatArray("sim/flightmodel2/misc/bouncer_vz");} }

        /// <summary>
        ///  True while the auto-start sequence is happening.  Plugins that override the auto-start sequence should set this to 1 during the sequence and clear it when done.. Units:boolean
        ///  Raw path: sim/flightmodel2/misc/auto_start_in_progress
        /// </summary>
        public IXPDataRef<bool> auto_start_in_progress { get { return m_data.GetBool("sim/flightmodel2/misc/auto_start_in_progress");} }

        /// <summary>
        ///  True while the auto-board sequence is happening.  Plugins that override the auto-board sequence should set this to 1 during the sequence and clear it when done.. Units:boolean
        ///  Raw path: sim/flightmodel2/misc/auto_board_in_progress
        /// </summary>
