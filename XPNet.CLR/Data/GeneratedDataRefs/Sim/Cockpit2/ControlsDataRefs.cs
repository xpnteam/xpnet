...
namespace XPNet.Data
{
    public class sim_cockpit2_controlsDataRefs
    {
        ...
        /// <summary>
        ///  This is how much the yoke is deflected in the cockpit, in ratio, where -1.0 is full down, and 1.0 is full up.. Units:This is how much the yoke is deflected in the cockpit, in ratio, where -1.0 is full down, and 1.0 is full up.
        ///  Raw path: sim/cockpit2/controls/yoke_pitch_ratio
        /// </summary>
        public IXPDataRef<float> yoke_pitch_ratio { get { return m_data.GetFloat("sim/cockpit2/controls/yoke_pitch_ratio");} }

        /// <summary>
        ///  This is how much the yoke is deflected in the cockpit, in ratio, where -1.0 is full left, and 1.0 is full right.. Units:This is how much the yoke is deflected in the cockpit, in ratio, where -1.0 is full left, and 1.0 is full right.
        ///  Raw path: sim/cockpit2/controls/yoke_roll_ratio
        /// </summary>
        public IXPDataRef<float> yoke_roll_ratio { get { return m_data.GetFloat("sim/cockpit2/controls/yoke_roll_ratio");} }

        /// <summary>
        ///  This is how much the rudder is deflected in the cockpit, in ratio, where -1.0 is full left, and 1.0 is full right.. Units:This is how much the rudder is deflected in the cockpit, in ratio, where -1.0 is full left, and 1.0 is full right.
        ///  Raw path: sim/cockpit2/controls/yoke_heading_ratio
        /// </summary>
        ...
        ///  Raw path: sim/cockpit2/controls/speedbrake_ratio
        /// </summary>
        ...
        ///  Raw path: sim/cockpit2/controls/wingsweep_ratio
        /// </summary>
        ...
        ///  Raw path: sim/cockpit2/controls/thrust_vector_ratio
        /// </summary>
        ...
        ///  Raw path: sim/cockpit2/controls/dihedral_ratio
        /// </summary>
        ...
        ///  Raw path: sim/cockpit2/controls/incidence_ratio
        /// </summary>
        ...
        ///  Raw path: sim/cockpit2/controls/wing_retraction_ratio
        /// </summary>
        ...
        ///  Raw path: sim/cockpit2/controls/flap_ratio
        /// </summary>
        ...
        ///  Raw path: sim/cockpit2/controls/parking_brake_ratio
        /// </summary>
        ...
        ///  Raw path: sim/cockpit2/controls/left_brake_ratio
        /// </summary>
        ...
        ///  Raw path: sim/cockpit2/controls/right_brake_ratio
        /// </summary>
        public IXPDataRef<float> right_brake_ratio { get { return m_data.GetFloat("sim/cockpit2/controls/right_brake_ratio");} }

        /// <summary>
        ///  Gear handle position. 0 is up. 1 is down.. Units:boolean
        ///  Raw path: sim/cockpit2/controls/gear_handle_down
        /// </summary>
        public IXPDataRef<bool> gear_handle_down { get { return m_data.GetBool("sim/cockpit2/controls/gear_handle_down");} }

        /// <summary>
        ///  Is the nosewheel steering turned on? 0 or 1.  This must be off AND the tail wheel must be unlocked to free castor.. Units:boolean
        ///  Raw path: sim/cockpit2/controls/nosewheel_steer_on
        /// </summary>
        ...
        ///  Raw path: sim/cockpit2/controls/tailwheel_lock_ratio
        /// </summary>
        public IXPDataRef<float> tailwheel_lock_ratio { get { return m_data.GetFloat("sim/cockpit2/controls/tailwheel_lock_ratio");} }

        /// <summary>
        ///  Aileron trim, in part of MAX FLIGHT CONTROL DEFLECTION. So, if the aileron trim is deflected enough to move the ailerons through 30% of their travel, then that is an aileron trim of 0.3. -1=left 1=right. Units:Aileron trim, in part of MAX FLIGHT CONTROL DEFLECTION. So, if the aileron trim is deflected enough to move the ailerons through 30% of their travel, then that is an aileron trim of 0.3. -1=left 1=right
        ///  Raw path: sim/cockpit2/controls/aileron_trim
        /// </summary>
        public IXPDataRef<float> aileron_trim { get { return m_data.GetFloat("sim/cockpit2/controls/aileron_trim");} }

        /// <summary>
        ///  Elevator trim, in part of MAX FLIGHT CONTROL DEFLECTION. So, if the elevator trim is deflected enough to move the elevators through 30% of their travel, then that is an elevator trim of 0.3. -1=down 1=up. Units:Elevator trim, in part of MAX FLIGHT CONTROL DEFLECTION. So, if the elevator trim is deflected enough to move the elevators through 30% of their travel, then that is an elevator trim of 0.3. -1=down 1=up
        ///  Raw path: sim/cockpit2/controls/elevator_trim
        /// </summary>
        public IXPDataRef<float> elevator_trim { get { return m_data.GetFloat("sim/cockpit2/controls/elevator_trim");} }

        /// <summary>
        ///  Rudder trim, in part of MAX FLIGHT CONTROL DEFLECTION. So, if the rudder trim is deflected enough to move the rudders through 30% of their travel, then that is an rudder trim of 0.3. -1=left 1=right. Units:Rudder trim, in part of MAX FLIGHT CONTROL DEFLECTION. So, if the rudder trim is deflected enough to move the rudders through 30% of their travel, then that is an rudder trim of 0.3. -1=left 1=right
        ///  Raw path: sim/cockpit2/controls/rudder_trim
        /// </summary>
        public IXPDataRef<float> rudder_trim { get { return m_data.GetFloat("sim/cockpit2/controls/rudder_trim");} }

        /// <summary>
        ///  Rotor trim, in part of MAX FLIGHT CONTROL DEFLECTION. So, if the rotor trim is deflected enough to move the rotor through 30% of its travel, then that is a rotor trim of 0.3. -1=down 1=up. Units:Rotor trim, in part of MAX FLIGHT CONTROL DEFLECTION. So, if the rotor trim is deflected enough to move the rotor through 30% of its travel, then that is a rotor trim of 0.3. -1=down 1=up
        ///  Raw path: sim/cockpit2/controls/rotor_trim
        /// </summary>
        ...
        ///  Raw path: sim/cockpit2/controls/water_rudder_handle_ratio
        /// </summary>
        ...
        ///  Raw path: sim/cockpit2/controls/flap_handle_deploy_ratio
        /// </summary>
